...
for (replic in REP_START:REP_END)
{
    ...
    ggsave(paste0("./output/ImmEsc-variant_check_", replic, ".pdf"), plot, width = 20, height = 6, units = "cm", useDingbats = FALSE)
    ...
    plot = ggplot(post) +
        ...
        expand_limits(x = 1)
    ggsave(paste0("./output/ImmEsc-variant_stats_", replic, ".pdf"), plot, width = 20, height = 6, units = "cm", useDingbats = FALSE)
    ...
    ggsave(paste0("./output/ImmEsc-fit_", replic, ".pdf"), plot, width = 30, height = 25, units = "cm", useDingbats = FALSE)
