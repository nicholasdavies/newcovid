...
p1 = project("relu", "./fits/relu12.qs", "scenario1.rds", VAX)
p2 = project("relu", "./fits/relu12.qs", "scenario2.rds", VAX)
p3 = project("relu", "./fits/relu12.qs", "scenario3.rds", VAX)
p5 = project("relu", "./fits/relu12.qs", "scenario5.rds", VAX)
